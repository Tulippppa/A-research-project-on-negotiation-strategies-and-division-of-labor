...
data2020 <- read_csv("TeleCom_Dyad_premeasures.csv")

#data2 <- read_csv("Downloads/psy 364/TeleCom_Dyad_premeasures (2).csv")
```
...
```{r}
psych::corr.test(select(data2020 , grbs_1, grbs_2.r, grbs_3.r, grbs_4.r, grbs_5.r,
...
```{r, warning = F}
psych::alpha(select(data2020 , grbs_1, grbs_2.r, grbs_3.r, grbs_4.r, grbs_5.r,
             grbs_6, grbs_7.r, grbs_8, grbs_9, grbs_10.r, grbs_11, grbs_12.r,
             grbs_13, grbs_14, grbs_15, grbs_16, grbs_17.r, grbs_18, grbs_19,
             grbs_20))
```
...
```{r}
corr.test(select(data2020, housework_1, housework_2, housework_3, housework_4, housework_5,
                 housework_6.r, housework_7, housework_8, housework_9, housework_10, housework_11,
                 housework_12, housework_13, housework_14))$r
```

```{r, warning = F}
psych::alpha(select(data2020, housework_1, housework_2, housework_3, housework_4, housework_5,
                 housework_6.r, housework_7, housework_8, housework_9, housework_10, housework_11,
                 housework_12, housework_13, housework_14))
```

```{r}
## creating scale score
data2020$data2020grbs <- rowMeans(select(data2020 , grbs_1, grbs_2.r, grbs_3.r, grbs_4.r, grbs_5.r,
...
```{r}
qplot(x = data2020grbs, data = data2020, bins = 20)
```

```{r}
## creating scale score
data2020$data2020housework <- rowMeans(select(data2020, housework_1, housework_2, housework_3, housework_4, housework_5, housework_6, housework_7, housework_8, housework_9, housework_10, housework_11, housework_12, housework_13, housework_14), na.rm = TRUE)
```
...
## cleaning data
data2020_2<- data2020 %>%
  select(dyadID, birthday, race, religion, gender,sexualor,grbs_1:grbs_20, housework_1:housework_13, data2020grbs,data2020housework, ResponseId ) %>%
 drop_na()
```


```{r}
data2020_gender<- data2020_2 %>%
  group_by(gender) %>%
  summarise(mean = mean(gender), n = n())
```

```{r}
data2020__race<- data2020_2 %>%
  group_by(race) %>%
  summarise(mean = mean(race), n = n())
```
